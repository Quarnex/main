    ...
    <div class="page-sidebar">
        <div class="profile-menu">
            <a href="app-profile.html">
                <img src="{{ asset('images/avatars/avatar1.png')}}" alt="">
            </a>
        </div>
                ...
                <div class="right-sidebar-content">
                    ...
                    <div class="chat-list">
                        ...
                        <a href="javascript:void(0);" class="right-sidebar-toggle chat-item" data-sidebar-id="chat-right-sidebar">
                            <div class="user-avatar">
                                <img src="{{ asset('images/avatars/avatar3.png')}}" alt="">
                            </div>
                            <div class="chat-info">
                        ...
                        <a href="javascript:void(0);" class="right-sidebar-toggle chat-item active-user" data-sidebar-id="chat-right-sidebar">
                            <div class="user-avatar">
                                <img src="{{ asset('images/avatars/avatar4.png')}}" alt="">
                            </div>
                            <div class="chat-info">
                        ...
                        <a href="javascript:void(0);" class="right-sidebar-toggle chat-item active-user" data-sidebar-id="chat-right-sidebar">
                            <div class="user-avatar">
                                <img src="{{ asset('images/avatars/avatar5.png')}}" alt="">
                            </div>
                            <div class="chat-info">
